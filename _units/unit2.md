...
> Given that this course has CS pre-requisites, we're assuming you're comfortable with progamming basics such as variables, loops, and functions. However, if you'd like to review them within the context of JavaScript, you may refer to the material below:
